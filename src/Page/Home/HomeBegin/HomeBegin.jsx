        ...
        <div className='lg:grid grid-cols-2 gap-4 lg:px-24 px-7 mt-10'>
            ...
            <div className=''>
                ...
                <div className='lg:grid grid-cols-2  gap-4 mt-5'>
                    ...
                    <div className='p-7 bg-red-300 lg:mt-0 mt-5'>
            ...
            <div className=''>
                ...
                <div className="hero lg:h-[436px]" style={{ backgroundImage: 'url(https://daisyui.com/images/stock/photo-1507358522600-9f71e620c44e.jpg)' }}>
